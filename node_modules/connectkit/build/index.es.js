...
const defaultConnectors = ({ app, walletConnectProjectId, coinbaseWalletPreference, enableFamily, familyOptions, }) => {
    const hasAllAppData = app.name && app.icon && app.description && app.url;
    const shouldUseSafeConnector = !(typeof window === 'undefined') && (window === null || window === void 0 ? void 0 : window.parent) !== window;
    const connectors = enableFamily
...
const defaultConfig = ({ appName = 'ConnectKit', appIcon, appDescription, appUrl, walletConnectProjectId, coinbaseWalletPreference, chains = [mainnet, polygon, optimism, arbitrum], client, enableFamily = true, familyOptions, ...props }) => {
    var _a, _b;
...
const OtherWallets = ({ ...props }) => {
    ...
    return (jsxs("div", { style: column, ...props, children: [jsxs("div", { style: row, children: [jsx("div", { style: cell, children: jsx(WalletConnect, { background: true }) }), jsx("div", { style: cell, children: !isArgent() ? jsx(Argent, {}) : jsx(Rabby, {}) })] }), jsxs("div", { style: row, children: [jsx("div", { style: cell, children: !isPhantom() ? jsx(Phantom, { background: true }) : jsx(ImToken, {}) }), jsx("div", { style: cell, children: !isSafe() ? jsx(Safe, {}) : jsx(Trust, {}) })] })] }));
};
...
`;
const InnerContainer$2 = styled(motion.div) `
  position: relative;
  overflow: hidden;
  height: var(--height);
...
const SIWE_NONCE_QUERY_KEY = 'ckSiweNonce';
const SIWE_SESSION_QUERY_KEY = 'ckSiweSession';
...
.`,
    ...
    signInWithEthereumScreen_tooltip: 'أنت غير مسجل الدخول حاليًا إلى هذا التطبيق.\n**سجل الدخول باستخدام إثيريوم** للمتابعة.',
...
const faIR = {
    ...
    signInWithEthereumScreen_tooltip: 'شما در حال حاضر به این برنامه وارد نشده‌اید.\n**با اتریوم وارد شوید** تا ادامه دهید.',
...
const Modal = ({ open, pages, pageId, positionInside, inline, demo, onClose, onBack, onInfo, }) => {
    ...
    const Content = (jsx(ResetContainer, { "$useTheme": (_e = demo === null || demo === void 0 ? void 0 : demo.theme) !== null && _e !== void 0 ? _e : themeContext.theme, "$useMode": (_f = demo === null || demo === void 0 ? void 0 : demo.mode) !== null && _f !== void 0 ? _f : themeContext.mode, "$customTheme": (_g = demo === null || demo === void 0 ? void 0 : demo.customTheme) !== null && _g !== void 0 ? _g : themeContext.customTheme, children: jsxs(ModalContainer, { role: "dialog", style: {
            ...
            }, children: [!inline && (jsx(BackgroundOverlay, { "$active": rendered, onClick: onClose, "$blur": (_h = context.options) === null || _h === void 0 ? void 0 : _h.overlayBlur })), jsxs(Container$8, { style: dimensionsCSS, initial: false, children: [jsx("div", { style: {
                                ...
                                transition: 'width 200ms ease',
                                        ...
                                        context.route === routes.CONNECTORS && (jsx(DisclaimerBackground, { initial: {
                                            ...
                                            ease: [0.25, 0.1, 0.25, 1.0],
                                                ...
                                                delay: mobile ? 0.01 : 0,
                                            }, children: jsx(FitText, { children: getHeading() }) }, `${context.route}-${isSignedIn ? 'signedIn' : ''}`) }) }), jsx(InnerContainer$2, { children: Object.keys(pages).map((key) => {
...
const OrDivider = ({ children, hideHr, }) => {
    const locales = useLocales();
    return (jsx(TextWithHr, { "$disableHr": hideHr, children: jsx("span", { children: children !== null && children !== void 0 ? children : locales.or }) }));
};
...
`;
const ButtonContainerInner$1 = styled(motion.div) `
  display: flex;
  align-items: center;
  justify-content: center;
  inset: 0;
  height: 100%;
`;
const ButtonContainer$2 = styled.button `
...
`;
const InnerContainer$1 = styled.div `
...
disabled, icon, iconPosition = 'left', roundedIcon, waiting, arrow, download, href, style, onClick, }) => {
    ...
    return (jsx(ButtonContainer$2, { as: href ? 'a' : undefined, onClick: (event) => {
            if (!disabled && onClick)
                onClick(event);
        }, href: hrefUrl, target: href && '_blank', rel: href && 'noopener noreferrer', disabled: disabled, "$variant": variant, style: style, children: jsxs(AnimatePresence, { initial: false, children: [jsxs(ButtonContainerInner$1, { initial: { opacity: 0, y: -10 }, animate: {
                        opacity: 1,
                        y: -1,
                    }, exit: {
                        position: 'absolute',
                        ...
                        ...transition$1,
                        delay: 0.2,
                    }, children: [icon && iconPosition === 'left' && (jsx(IconContainer$5, { "$rounded": roundedIcon, children: icon })), download && (jsx(DownloadArrow, { children: jsx(DownloadArrowInner, { children: jsxs(Arrow, { width: "13", height: "12", viewBox: "0 0 13 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsx(ArrowLine, { stroke: "currentColor", x1: "1", y1: "6", x2: "12", y2: "6", strokeWidth: "var(--stroke-width)", strokeLinecap: "round" }), jsx(ArrowChevron, { stroke: "currentColor", d: "M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314", strokeWidth: "var(--stroke-width)", strokeLinecap: "round" })] }) }) })), jsx(InnerContainer$1, { style: { paddingLeft: arrow ? 6 : 0 }, children: jsx(FitText, { children: children }) }), icon && iconPosition === 'right' && (jsx(IconContainer$5, { "$rounded": roundedIcon, children: icon })), arrow && (jsxs(Arrow, { width: "13", height: "12", viewBox: "0 0 13 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsx(ArrowLine, { stroke: "currentColor", x1: "1", y1: "6", x2: "12", y2: "6", strokeWidth: "2", strokeLinecap: "round" }), jsx(ArrowChevron, { stroke: "currentColor", d: "M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314", strokeWidth: "2", strokeLinecap: "round" })] }))] }, key), waiting && (jsx(SpinnerContainer$3, { children: jsx(Spinner$4, {}) }))] }) }));
};
...
const Alert = ({ children, error, icon }) => {
    return (jsxs(AlertContainer, { "$error": error, children: [icon && jsx(IconContainer$4, { children: icon }), jsx("div", { children: children })] }));
};
...
const ConnectorItem = ({ wallet, isRecent, }) => {
    ...
    */
    ...
    return (jsxs(ConnectorButton, { type: "button", as: deeplink ? 'a' : undefined, href: deeplink ? deeplink : undefined, disabled: context.route !== routes.CONNECTORS, onClick: deeplink
            ...
            }, children: [jsx(ConnectorIcon, { "data-small": wallet.iconShouldShrink, "data-shape": wallet.iconShape, "data-background": redirectToMoreWallets, children: (_b = wallet.iconConnector) !== null && _b !== void 0 ? _b : wallet.icon }), jsxs(ConnectorLabel, { children: [isMobile ? (_c = wallet.shortName) !== null && _c !== void 0 ? _c : wallet.name : wallet.name, !((_d = context.options) === null || _d === void 0 ? void 0 : _d.hideRecentBadge) && isRecent && (jsx(RecentlyUsedTag, { children: jsx("span", { children: "Recent" }) }))] })] }));
};
...
const Wallets = () => {
    ...
    return (jsx(PageContent, { style: {
        ...
        }, children: jsxs(Container$7, { children: [familyAccountsConnector && (jsxs(Fragment, { children: [jsx(FamilyAccountsButton, { onClick: () => {
                                if (familyConnector && isFamily()) {
...
const ConnectWithInjector = ({ switchConnectMethod, forceState }) => {
    ...
    */
    ...
    return (jsx(PageContent, { children: jsxs(Container$4, { children: [jsx(ConnectingContainer, { children: jsxs(ConnectingAnimation, { "$shake": status === states$1.FAILED || status === states$1.REJECTED, "$circle": walletInfo.iconShape === 'circle', children: [jsx(AnimatePresence, { children: (status === states$1.FAILED || status === states$1.REJECTED) && (jsx(RetryButton, { "aria-label": "Retry", initial: { opacity: 0, scale: 0.8 }, animate: { opacity: 1, scale: 1 }, exit: { opacity: 0, scale: 0.8 }, whileTap: { scale: 0.9 }, transition: { duration: 0.1 }, onClick: runConnect, children: jsx(RetryIconContainer, { children: jsx(Tooltip, { open: showTryAgainTooltip &&
                                        ...
                                        position: 'relative',
                                        width: '100%',
                                    }, children: walletInfo.icon })) : (jsx(Fragment, { children: walletInfo.icon })), connecting: status === states$1.CONNECTING }))] }) }), jsx(ModalContentContainer, { children: jsxs(AnimatePresence, { initial: false, children: [status === states$1.FAILED && (jsxs(Content, { initial: 'initial', animate: 'animate', exit: 'exit', variants: contentVariants$1, children: [jsxs(ModalContent, { children: [jsxs(ModalH1, { "$error": true, children: [jsx(AlertIcon, {}), locales.injectionScreen_failed_h1] }), jsx(ModalBody, { children: locales.injectionScreen_failed_p })] }), isFamilyAccountsConnector(wallet.id) && (jsxs(Fragment, { children: [jsx(OrDivider, {}), jsx(Button, { onClick: () => switchConnectMethod(id), children: locales.connectWithFamilyIOS })] }))] }, states$1.FAILED)), status === states$1.REJECTED && (jsxs(Content, { initial: 'initial', animate: 'animate', exit: 'exit', variants: contentVariants$1, children: [jsxs(ModalContent, { style: isFamilyAccountsConnector(wallet.connector.id)
                                            ? { paddingBottom: 12 }
                                            : {
                                                paddingBottom: 28,
                                            }, children: [jsx(ModalH1, { children: locales.injectionScreen_rejected_h1 }), jsx(ModalBody, { children: locales.injectionScreen_rejected_p })] }), isFamilyAccountsConnector(wallet.id) && (jsxs(Fragment, { children: [jsx(OrDivider, {}), jsx(Button, { onClick: () => switchConnectMethod(id), children: locales.connectWithFamilyIOS })] }))] }, states$1.REJECTED)), (status === states$1.CONNECTING || status === states$1.EXPIRING) && (jsx(Content, { initial: 'initial', animate: 'animate', exit: 'exit', variants: contentVariants$1, children: jsxs(ModalContent, { style: {
                                        paddingBottom: 28,
    ...
    return (jsxs(PageContent, { children: [jsxs(ModalContent, { style: { paddingBottom: 8, gap: 14 }, children: [jsx(CustomQRCode, { value: uri, image: wallet === null || wallet === void 0 ? void 0 : wallet.icon, tooltipMessage: isWalletConnectConnector(id) ? (jsxs(Fragment, { children: [jsx(ScanIconWithLogos, {}), jsx("span", { children: locales.scanScreen_tooltip_walletConnect })] })) : (jsxs(Fragment, { children: [jsx(ScanIconWithLogos, { logo: wallet === null || wallet === void 0 ? void 0 : wallet.icon }), jsx("span", { children: locales.scanScreen_tooltip_default })] })) }), showAdditionalOptions ? (jsx(OrDivider, {})) : (hasApps && jsx(OrDivider, { children: locales.dontHaveTheApp }))] }), showAdditionalOptions && ( // for walletConnect
            jsxs("div", { style: {
                    ...
                    gap: 14,
                            ...
                            : locales.useModal }))] })), isFamilyAccountsConnector(wallet.id) && (jsxs(Fragment, { children: [jsx(OrDivider, {}), jsx(Button, { onClick: () => switchConnectMethod(id), children: locales.loginWithEmailOrPhone })] })), hasApps && (jsx(Fragment, { children: jsx(Button, { onClick: () => {
...
const chainConfigs = [
    ...
    },
    {
        id: 232,
        name: 'Lens Chain',
        logo: jsx(Chains.LensChain, {}),
    },
    {
        id: 37111,
        name: 'Lens Chain Testnet',
        logo: jsx(Chains.LensChain, { testnet: true }),
    },
    {
        id: 3,
        name: 'Rinkeby',
...
const CONNECTKIT_VERSION = '1.9.0';

export { Avatar, CONNECTKIT_VERSION, Chain as ChainIcon, ConnectKitButton, ConnectModal as ConnectKitModalDemo, ConnectKitProvider, Context, SIWEButtonComponent as SIWEButton, SIWEProvider, SIWE_NONCE_QUERY_KEY, SIWE_SESSION_QUERY_KEY, types as Types, defaultConfig as getDefaultConfig, defaultConnectors as getDefaultConnectors, useChainIsSupported, useChains, useIsMounted, useModal, useSIWE, wallets };
